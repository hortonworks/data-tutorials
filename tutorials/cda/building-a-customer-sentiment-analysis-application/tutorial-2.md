...
The final service we will need to setup is Solr. Since Solr isn't installed initially on HDP Sandbox,
we will need to install it using Ambari Install Wizard UI.

### Install Solr

1\. Open Ambari at `http://sandbox-hdp.hortonworks.com:8080` with login `raj_ops/raj_ops`.

2\. From Ambari stack of services, press **Actions**, **+ Add Service** and in the **Choose Services** list, check the box next to **Solr** version **5.5.2.2.5**, then press **Next-->**.
